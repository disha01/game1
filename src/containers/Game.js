        ...
        return (
            <div className={css(styles.container)} >
                ...
                <div className={css(styles.controlContainer)}>
                    {this.gameState != GAMESTATE.IN_PROGRESS &&
                        <Button variant="contained" size="small" color="primary" className={css(styles.buttons)} onClick={this._startGame}> {this.letters.length > 0 ? "Resume" : "Start game"}</Button>}
                    {this.gameState != GAMESTATE.PAUSED && this.gameState === GAMESTATE.IN_PROGRESS &&
                        <Button variant="contained" size="small" color="primary" className={css(styles.buttons)} onClick={this._pauseGame}> Pause</Button>}
